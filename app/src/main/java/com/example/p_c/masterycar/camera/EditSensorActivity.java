...
//		topRelativeLayout.setBackgroundDrawable(drawable);
	...
	public void onClick(View v) {
		...
		case R.id.btn_delete:
			...
			vstc2.nativecaller.NativeCaller.TransferMessage(did, "del_sensor.cgi?" + "&sensorid="
...
//	}
	...
	{
		vstc2.nativecaller.NativeCaller.TransferMessage(did, "set_sensor_preset.cgi?sensorid="
