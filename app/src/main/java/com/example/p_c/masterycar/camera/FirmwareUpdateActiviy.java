...
//				getFirmware();
			...
			case 1:
				...
				.setNegativeButton("暂不更新",new DialogInterface.OnClickListener()
				{
					...
					public void onClick(DialogInterface dialog, int which) {
										// TODO Auto-generated method stub
						sys_isnew = false;
						vstc2.nativecaller.NativeCaller.UpgradeFirmware(did,download_server, filePath_sys,0);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		vstc2.nativecaller.NativeCaller.PPPPGetSystemParams(did, ContentCommon.MSG_TYPE_GET_STATUS);
		BridgeService.setFirmware((BridgeService.Firmware) this);
	}
