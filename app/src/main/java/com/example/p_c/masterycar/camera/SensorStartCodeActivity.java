...
public class SensorStartCodeActivity extends Activity implements OnClickListener,BridgeService.SensorSetCodeInterface
{
	...
	private void getData() 
	{
		...
		vstc2.nativecaller.NativeCaller.TransferMessage(did,"set_sensorstatus.cgi?cmd=2&loginuse=admin&loginpas=" + pwd + "&user=admin&pwd=" + pwd, 1);
		startTimer();
		BridgeService.setCodeInterface((BridgeService.SensorSetCodeInterface) this);
	}
...
//			sensorname = getString(R.string.sensor_list_sensor);
	...
	private void setSensorName(String name, int id) {
		...
		vstc2.nativecaller.NativeCaller.TransferMessage(did, "set_sensorname.cgi?" + "&sensorid="
